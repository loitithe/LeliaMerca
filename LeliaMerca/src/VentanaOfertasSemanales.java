...
public class VentanaOfertasSemanales extends JFrame implements ActionListener {
        ...
        public VentanaOfertasSemanales(AplicacionUsuario app, String tipoUsuario) {
                ...
                panelOfertas = new JPanel(new GridLayout(3, 3));
                for (Producto producto : listaOfertas) {
                        ...
                        panelOfertas.add(spinner);

                }
                panelPrincipal.add(panelOfertas, BorderLayout.CENTER);

                panelCarrito = new JPanel(new GridLayout(1, 1));
        ...
        private void generarOfertas() {
                listaOfertas.add(new Producto("Manzanas", 2.99, "Manzanas frescas de temporada.",
                                new ImageIcon("manzanas.avif")));
                listaOfertas.add(new Producto("Arroz Integral", 3.49, "Arroz integral de alta calidd.",
                                new ImageIcon("arroz_integral.jpg")));
                listaOfertas.add(new Producto("Pollo Entero", 6.99, "Pollo entero fresco.",
                                new ImageIcon("pollo_entero.jpg")));
                // listaOfertas.add(
                // new Producto("Pasta de Tomate", 1.99, "Pasta de tomate casera.",
                // new ImageIcon("pasta_tomate.jpg")));
                // listaOfertas.add(new Producto("Leche Desnatada", 2.29, "Leche desnatada sin
                // lactosa.",
                // new ImageIcon("leche_desnatada.jpg")));
                // listaOfertas.add(
                // new Producto("Cereal de Avena", 4.79, "Cereal de avena orgánico.",
                // new ImageIcon("cereal_avena.jpg")));
                // listaOfertas.add(
                // new Producto("Salmon Fresco", 9.99, "Filetes de salmón fresco.",
                // new ImageIcon("salmon_fresco.jpg")));
                // listaOfertas.add(
                // new Producto("Yogur Natural", 0.99, "Yogur natural sin azúcar.",
                // new ImageIcon("yogur_natural.jpg")));
                // listaOfertas.add(
                // new Producto("Pan Integral", 2.49, "Pan integral recién horneado.",
                // new ImageIcon("pan_integral.jpg")));
                // listaOfertas.add(new Producto("Aceite de Oliva", 5.99, "Aceite de oliva
                // virgen extra.",
                // new ImageIcon("aceite_oliva.jpg")));
                // listaOfertas
                // .add(new Producto("Huevos (docena)", 2.49, "Docena de huevos frescos.",
                // new ImageIcon("huevos.jpg")));
                // listaOfertas.add(new Producto("Cebollas", 1.29, "Cebollas orgánicas.", new
                // ImageIcon("cebollas.jpg")));
                // listaOfertas
                // .add(new Producto("Pimiento Rojo", 1.99, "Pimiento rojo fresco.",
                // new ImageIcon("pimiento_rojo.jpg")));
                // listaOfertas.add(new Producto("Lechuga Iceberg", 0.99, "Lechuga iceberg
                // crujiente.",
                // new ImageIcon("lechuga_iceberg.jpg")));
                // listaOfertas.add(new Producto("Papas", 2.79, "Papas de la temporada.", new
                // ImageIcon("papas.jpg")));
                // listaOfertas.add(new Producto("Atún enlatado", 1.49, "Atún enlatado de alta
                // calidad.",
                // new ImageIcon("atun_enlatado.jpg")));
                // listaOfertas.add(new Producto("Galletas de Chocolate", 3.29, "Galletas de
                // chocolate premium.",
                // new ImageIcon("galletas_chocolate.jpg")));
                // listaOfertas
                // .add(new Producto("Café Molido", 4.99, "Café molido de Colombia.",
                // new ImageIcon("cafe_molido.jpg")));
                // listaOfertas.add(new Producto("Fresas", 2.99, "Fresas frescas de la región.",
                // new ImageIcon("fresas.jpg")));
                // listaOfertas.add(new Producto("Mantequilla", 2.49, "Mantequilla de calidad
                // superior.",
        ...
        public void actionPerformed(ActionEvent e) {
                ...
                for (Producto producto : listaOfertas) {
                        if (btn.getName() == producto.getNombre()) {
                                double precioProducto = Double.parseDouble(cantidadComprar.getText())
                                                * producto.getPrecio();
